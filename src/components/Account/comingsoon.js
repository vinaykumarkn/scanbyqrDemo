const comingsoon = () => {
    return (<section class="bg-white px-4 dark:bg-boxdark-2 sm:px-8 overflow-hidden relative z-10">
        <div class="flex h-screen flex-col items-center justify-center overflow-hidden">
            <div class="no-scrollbar overflow-y-auto py-6">
                <div class="mx-auto w-full max-w-[600px]">
                   ...
                   <img class="w-[148px] dark:hidden" src="../../assets/images/header-logo.png" alt="Logo" />
                        ...
                        <h1
                            class="mb-3 text-3xl font-black text-black dark:text-white lg:text-4xl xl:text-[50px] xl:leading-[60px]">
                            Coming Soon
                        </h1>
                ...
                <div class="mt-10 flex flex-wrap justify-center gap-6" x-data="timer()" x-init="countdown()">
                    ...
                    <div>
                        <div class="mb-3 flex items-center gap-2">
                            <template x-for="(day, index) in daysArray" >
                                <div x-show="day.visible" class="timer-box relative overflow-hidden rounded-lg">
                                    <span
                                        class="flex h-16 min-w-[56px] items-center justify-center rounded-lg bg-black px-3 text-xl font-black leading-[1.35] text-white dark:bg-boxdark lg:text-3xl xl:text-[40px]"
                    ...
                    <div>
                        <div class="mb-3 flex items-center gap-2">
                            <template x-for="(hour, index) in hoursArray" >
                    ...
                    <div>
                        <div class="mb-3 flex items-center gap-2">
                            <template x-for="(minute, index) in minutesArray" >
                    ...
                    <div>
                        <div class="mb-3 flex items-center gap-2">
                            <template x-for="(second, index) in secondsArray" >
                ...
                {/* < !--form start-- > */}
                <div class="mx-auto mt-12 w-full max-w-[580px]">
                    <form>
                        <div class="flex">
                            <input type="email" name="email" id="email" placeholder="Enter your email"
                                class="placeholder:text-dark-4 w-full rounded-l-md border-[1.5px] border-r-0 border-stroke px-6 py-3 text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" />
                            <button type="submit"
                                class="inline-flex justify-center rounded-r-md bg-primary px-4 py-3 font-medium text-white duration-200 ease-out hover:bg-opacity-90 sm:px-6">
                                Subscribe
                            </button>
                        </div>
                    </form>

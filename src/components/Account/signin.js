...
const Signin = () => {
    return (<div class="mx-auto max-w-screen-2xl p-[16px] md:p-6 2xl:p-10">
            {/* <!-- Breadcrumb Start --> */}
            ...
            <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
              <div class="flex items-center">
                <div class="hidden w-full md:block xl:w-1/2">
                ...
                <div class="w-full border-stroke dark:border-strokedark xl:w-1/2 md:border-l-2">
                  <div class="w-full p-[16px] sm:p-12 xl:p-16">
                    ...
                    <form>
                      ...
                      <div class="mt-6 text-center">
                        <p class="font-medium">
                          ...
                          <Link  to="/User/Signup" className="text-primary" >Sign Up</Link>
                        </p>
                      </div>
                    </form>
                  </div>

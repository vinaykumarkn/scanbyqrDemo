const undermaintenance = () => {
    return (<section class="bg-white px-4 dark:bg-boxdark-2 sm:px-6">
        <div class="flex h-screen flex-col overflow-hidden">
            <div class="flex flex-wrap items-center">
                <div
                    class="no-scrollbar h-screen w-full overflow-y-auto border-stroke dark:border-strokedark lg:w-1/2 lg:border-r xl:flex xl:items-center xl:justify-center"
                >
                    <div class="px-4 py-20 xl:px-0">
                        <div>
                   ...
                   <img class="w-[148px] dark:hidden" src="../../assets/images/header-logo.png" alt="Logo" />
                        ...
                        {/* <!-- Countdown timer --> */}
                        <div class="mt-10 flex flex-wrap gap-6" x-data="timer()" x-init="countdown()">
                            {/* <!-- timer days --> */}
                            <div>
                ...
                <div class="w-full lg:block lg:w-1/2">
                    <div class="text-center">
                        <span class="inline-block">
                            ...
                            <img src="../../assets/images/illustration-04.svg" alt="illustration" />
                        </span>
                    </div>
                </div>
            </div >

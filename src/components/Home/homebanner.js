const homebanner = () => {
    return (<div className=" justify-between items-center">
        <div id="hero" className="section relative z-0   bg-gray-50">
            <div className="container xl:max-w-6xl mx-auto px-4">
                <div className="flex flex-wrap flex-row -mx-4 justify-center">
                    {/* <!-- content --> */}
                    <div
                        className="flex-shrink max-w-full px-12 lg:px-18 w-full sm:w-9/12 lg:w-1/2 self-center">
                        <img src="../../assets/images/hero.svg"
                            className="w-9/12 max-w-full h-auto" alt="creative agency" />
                        ...
                        <div className="sm:text-center lg:text-left mt-6 lg:mt-0">
                            <div className="mb-12">
                                ...
                                <p
                                    ...
                                    We would direct you to limitless ideas and move your brand into a
                                    global landscape.</p>
                            </div>
                            <a className="py-2.5 px-10 inline-block text-center leading-normal text-gray-900 bg-white border-b border-gray-100 hover:text-black hover:ring-0 focus:outline-none focus:ring-0 mr-4"
                                href="#portfolio">
                                <svg xmlns="http://www.w3.org/2000/svg" className="inline-block mr-1"
                            ...
                            <a className="py-2.5 px-10 inline-block text-center leading-normal text-gray-100 bg-black border-b border-gray-800 hover:text-white hover:ring-0 focus:outline-none focus:ring-0"
                                target="_blank" href="https://aribudin.gumroad.com/l/tailone">
                                <svg xmlns="http://www.w3.org/2000/svg" width="1.5rem" height="1.5rem"
                                    className="inline-block mr-1" fill="currentColor" viewBox="0 0 512 512">

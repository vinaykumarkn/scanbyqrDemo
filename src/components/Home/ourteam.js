...
const ourteam = ({ items }) => {
    return (<div className="lg:col-span-8  ">
        <div className="relative overflow-hidden rounded-md shadow dark:shadow-gray-700 bg-white dark:bg-slate-900">
            <div className="p-6 flex items-center justify-between border-b border-gray-100 dark:border-gray-800">
                <h6 className="text-lg font-semibold">Our Team</h6>
            </div>
                            ...
                            <div className="relative overflow-hidden bg-white dark:bg-gray-800 mb-12 hover-grayscale-0 wow fadeInUp"
                                ...
                                <div className="pt-6 text-center">
                                    ...
                                    <div className="mt-2 mb-5 space-x-2">
                                        <a className="hover:text-blue-700" aria-label="Twitter link"
                                            href="#">
                                            {/* <!-- <i className="fab fa-twitter text-twitter"></i> --> */}
                                            <svg xmlns="http://www.w3.org/2000/svg" className="inline-block"
                                        ...
                                        <a className="hover:text-blue-700" aria-label="Facebook link"
                                            href="#">
                                        ...
                                        <a className="hover:text-blue-700" aria-label="Instagram link"
                                            href="#">
                                        ...
                                        <a className="hover:text-blue-700" aria-label="Linkedin link"
                                            href="#">
